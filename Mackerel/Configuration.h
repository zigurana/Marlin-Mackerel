...
// BASIC SETTINGS: select your board type, temperature sensor type, and axis scaling

// User-specified version info of this build to display in [Pronterface, etc] terminal window during
// startup. Implementation of an idea by Prof Braino to inform user that any changes made to this
// build by the user have been successfully uploaded into firmware.
#define STRING_VERSION_CONFIG_H __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "Zigurana" // Who made the changes.
...
// DaPo: only support MB 34 for now
...
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER
 ...
 #define REPRAP_DISCOUNT_SMART_CONTROLLER
 #define ULTIPANEL
    // #define SDSUPPORT   // DaPo: while supported by the HW, I see no use case for loading/reading SD data 
    #define ULTRA_LCD
